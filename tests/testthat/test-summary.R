...
test_that("Summary outputs the right element for naive survival", {
  ...
  expected <- data.frame(
    ...
    trt.effect = c(0.6742, 0.6646, 0.7088, 0.6424, 0.5055, 0.7168, 0.6214,
    ...
    trt.conf.low = c(0.4694, 0.4664, 0.4744, 0.4637, 0.3004, 0.5366, 0.4133,
    ...
    trt.conf.high = c(0.9684, 0.9471, 1.059, 0.8901, 0.8507, 0.9577, 0.9341,
...
test_that("Summary outputs the right element for naive binary", {
  ...
  expected <- data.frame(
    subgroup = c("x_1.a", "x_1.b", "x_2.a", "x_2.b", "x_3.a", "x_3.b", "x_4.a",
                 ...
                 "x_6.b", "x_7.a", "x_7.b", "x_8.a", "x_8.b", "x_8.c", "x_9.a",
                 "x_9.b", "x_10.a", "x_10.b", "x_10.c"),
    trt.effect = c(-0.4621, -0.4217, -0.3952, -0.4786, -0.7587, -0.3707,
    ...
    trt.conf.low = c(-0.8808, -0.8259, -0.8551, -0.8537, -1.3794, -0.7006,
                     ...
                     -0.9226),
    trt.conf.high = c(-0.0433, -0.0176, 0.0647, -0.1034, -0.138, -0.0407,
