...
### Preprocessing_data
The `preprocessing_data`function is used to obtain from the original data frame 3 different design matrices and a vector with the name of the subgroups that are going to be studied. 
